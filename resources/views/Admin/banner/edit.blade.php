    ...
    <form class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" id="name" name="name" @if(!empty($info->name)) value="{{ $info->name }}" @endif>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>url跳转：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                @if(!empty($info->image))
                    <img src="{{ $info->image }}" alt="没有图片" width="100px">
                @endif
            </div>
        </div>
        <div class="row cl">
