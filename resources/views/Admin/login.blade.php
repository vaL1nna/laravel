        ...
        <form class="form form-horizontal" action="/admin/login" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    ...
                    <img id="image" src="{{ captcha_src() }}" onclick="changeCaptcha()"> <a id="kanbuq" href="javascript:;" onclick="changeCaptcha()">看不清，换一张</a> </div>
            </div>
            <div class="row cl">
                <div class="formControls col-xs-8 col-xs-offset-3">
                    <label for="online">
...
<script>
    function changeCaptcha() {
        $("#image") . attr("src", "{{ captcha_src() }}" + Math . random())
    }
</script>
<!--/此乃百度统计代码，请自行删除
</body>
